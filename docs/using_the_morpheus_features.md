...
[Summary](README.md#summary-data) | ms{ind}_{feature} | Word-level features containing a summary indexed per lemma of all related analytic blocks returned by Morpheus. This group also contains features that assist programmatic access to the detailed features.
[Detail](README.md#detail-data) | md{ind}_{feature} | Word-level features providing access to (almost) all details in the Morpheus analytical blocks
[Analytic](README.md#analytic-data) | ma{ind}_{feature} | Phrase-level features derived from Morpheus analyses cross-referenced with N1904-TF morphosyntactic tags
