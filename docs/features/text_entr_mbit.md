...
Absolute Shannon entropy of the distribution of parent phrase function (like Subject, Object, etc.) for each surface level wordform (feature[`text`](https://centerblc.github.io/N1904/features/text.html)).
